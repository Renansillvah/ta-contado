-- =============================================================================
-- TÁ CONTADO — SCHEMA DE PRODUÇÃO (SaaS)
-- =============================================================================

-- ── Utilitário: atualiza updated_at automaticamente ──────────────────────────
...
-- Trigger: cria assinatura free ao criar perfil
...
-- =============================================================================
-- 4. GASTOS — colunas adicionais de produção
-- =============================================================================
ALTER TABLE gastos
  ADD COLUMN IF NOT EXISTS updated_at   TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  ADD COLUMN IF NOT EXISTS is_recurring BOOLEAN NOT NULL DEFAULT FALSE,
  ADD COLUMN IF NOT EXISTS recurrence   TEXT CHECK (recurrence IN ('diario','semanal','mensal','anual')),
...
-- =============================================================================
-- 5. RECEITAS — colunas adicionais de produção
-- =============================================================================
...
-- =============================================================================
-- 6. DÍVIDAS — colunas adicionais de produção
-- =============================================================================
ALTER TABLE dividas
  ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  ADD COLUMN IF NOT EXISTS status     TEXT NOT NULL DEFAULT 'ativa' CHECK (status IN ('ativa', 'quitada', 'negociada')),
  ADD COLUMN IF NOT EXISTS juros_pct  NUMERIC(5,2),
  ADD COLUMN IF NOT EXISTS notes      TEXT,
  ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMPTZ;
...
CREATE TRIGGER dividas_updated_at
...
CREATE POLICY "app_events_insert_own" ON app_events FOR INSERT
  TO authenticated WITH CHECK (auth.uid() = user_id OR user_id IS NULL);

CREATE POLICY "app_events_select_own" ON app_events FOR SELECT
  TO authenticated USING (auth.uid() = user_id);
