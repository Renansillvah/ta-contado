-- =============================================
-- MEU ASSESSOR - Setup SQL para Supabase
...
-- Políticas: acesso público por enquanto (sem autenticação)
CREATE POLICY "Acesso público gastos" ON gastos FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Acesso público dividas" ON dividas FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Acesso público receitas" ON receitas FOR ALL USING (true) WITH CHECK (true);
